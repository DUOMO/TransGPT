...
DESCRIPTION = '''# <a href="https://github.com/DUOMO/TransGPT/tree/main">TransGPT-MM</a>'''
...
NOTES = 'This app is adapted from <a href="https://github.com/DUOMO/TransGPT/tree/main">https://github.com/DUOMO/TransGPT/tree/main</a>. It would be recommended to check out the repo if you want to see the detail of our model and training process.'
