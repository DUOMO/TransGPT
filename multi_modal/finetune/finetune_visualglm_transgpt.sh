...
train_data="./collection/dataset_v2.json"
eval_data="./collection/dataset_v2.json"
...
# nohup bash finetune/finetune_visualglm_transgpt.sh > trans.log 2>&1 &
